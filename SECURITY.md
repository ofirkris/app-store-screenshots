...
If you find a security issue, please open a GitHub issue on this repository. For sensitive disclosures, email the repository owner directly (see GitHub profile).

## Hardening Measures

This fork includes the following mitigations (not present in the upstream repo):
...
This is a security-hardened fork of [ParthJadhav/app-store-screenshots](https://github.com/ParthJadhav/app-store-screenshots). The upstream repo does not have a security policy.
